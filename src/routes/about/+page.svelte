...
<div class="text">
    ...
    <h3>Adaptive design is critical - an engineer must be able to roll with changes.</h3>
    <div class="split_box">
        <div class="box_split_left">
